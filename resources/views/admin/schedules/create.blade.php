                ...
                <div class="col-lg-12">
                    ...
                    <div class="form-row mb-3">
                        ...
                        <div class="col">
                            ...
                            {!! Form::date('schedule_date', null, ['class' => 'form-control', 'id' => 'schedule_date', 'placeholder' => 'Select schedule date']) !!}
                            @error('schedule_date')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-row mb-3">
                        <div class="col">
                            ...
                            {!! Form::time('start_time', null, ['class' => 'form-control', 'id' => 'start_time', 'placeholder' => 'Enter start time']) !!}
                            @error('start_time')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="col">
                            ...
                            {!! Form::time('end_time', null, ['class' => 'form-control', 'id' => 'end_time', 'placeholder' => 'Enter end time']) !!}
                            @error('end_time')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
